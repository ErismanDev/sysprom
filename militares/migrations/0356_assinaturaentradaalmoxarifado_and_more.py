# Generated by Django 5.2.3 on 2025-11-10 23:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('militares', '0355_assinaturarequisicaoalmoxarifado_and_more'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name='AssinaturaEntradaAlmoxarifado',
            fields=[
                ...
                ('tipo_assinatura', models.CharField(choices=[('RECEBIMENTO', 'Recebimento'), ('ENTREGA', 'Entrega'), ('OUTROS', 'Outros')], default='RECEBIMENTO', max_length=20, verbose_name='Tipo de Assinatura')),
        ...
        migrations.CreateModel(
            name='AssinaturaSaidaAlmoxarifado',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('data_assinatura', models.DateTimeField(auto_now_add=True, verbose_name='Data da Assinatura')),
                ('observacoes', models.TextField(blank=True, null=True, verbose_name='Observações da Assinatura')),
                ('tipo_assinatura', models.CharField(choices=[('ENTREGA', 'Entrega'), ('RECEBIMENTO', 'Recebimento'), ('OUTROS', 'Outros')], default='ENTREGA', max_length=20, verbose_name='Tipo de Assinatura')),
                ('funcao_assinatura', models.CharField(blank=True, help_text='Função/cargo do usuário no momento da assinatura', max_length=200, null=True, verbose_name='Função no momento da assinatura')),
            ],
            options={
        ...
        # Adicionar colunas apenas se não existirem (já podem ter sido adicionadas na migração 0355)
        migrations.RunSQL(
            sql="""
                DO $$
                BEGIN
        ...
        migrations.AddField(
            model_name='assinaturaentradaalmoxarifado',
            name='assinado_por',
        ...
        migrations.AddField(
            model_name='assinaturaentradaalmoxarifado',
            name='entrada',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assinaturas', to='militares.entradaalmoxarifado', verbose_name='Entrada de Almoxarifado'),
        ),
        migrations.AddField(
            model_name='assinaturaentradaalmoxarifado',
            name='militar',
            field=models.ForeignKey(blank=True, help_text='Militar que assina a entrada', null=True, on_delete=django.db.models.deletion.SET_NULL, to='militares.militar', verbose_name='Militar'),
        ),
        migrations.AddField(
            model_name='assinaturasaidaalmoxarifado',
            name='assinado_por',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Assinado por'),
        ),
        migrations.AddField(
            model_name='assinaturasaidaalmoxarifado',
            name='militar',
            field=models.ForeignKey(blank=True, help_text='Militar que assina a saída', null=True, on_delete=django.db.models.deletion.SET_NULL, to='militares.militar', verbose_name='Militar'),
        ),
        migrations.AddField(
            model_name='assinaturasaidaalmoxarifado',
            name='saida',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assinaturas', to='militares.saidaalmoxarifado', verbose_name='Saída de Almoxarifado'),
        ),
