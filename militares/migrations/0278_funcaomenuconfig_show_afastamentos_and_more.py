# Generated by Django 5.0.2 on 2025-10-29 22:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("militares", "0277_fix_unique_constraint_excluido"),
    ...
    operations = [
        migrations.AddField(
            ...
            name="show_afastamentos",
            field=models.BooleanField(default=False, verbose_name="Afastamentos"),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "AFASTAMENTO_LICENCA_ESPECIAL",
                                "Afastamento/Licença Especial",
                            ),
                            (
                            ...
                            (
                                "AFASTAMENTO_TEMPORARIO_LUTO",
                                "Afastamento Temporariamente/Luto",
                            ),
                            (
                ...
                (
                    "data_fim_prevista",
                    models.DateField(
                        blank=True, null=True, verbose_name="Data de Fim Prevista"
                    ),
                ),
                (
                    "data_fim_real",
                ...
                (
                    "motivo",
                    models.TextField(
                        help_text="Descrição detalhada do motivo do afastamento",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="afastamentos_cadastrados",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["-data_inicio"], name="militares_a_data_in_a35428_idx"
                    ),
                    models.Index(
                        fields=["status"], name="militares_a_status_5cf637_idx"
                    ),
                    models.Index(
                        fields=["militar"], name="militares_a_militar_c58fd7_idx"
                    ),
                ],
            },
        ),
