...
# -*- coding: utf-8 -*-
"""
Corrigir migrações problemáticas e configurar Supabase
"""
...
print("=== Corrigindo Migrações e Configurando Supabase ===")
...
try:
    ...
    print("2. Limpando banco completamente...")
    with connection.cursor() as cursor:
    ...
    print("3. Removendo migração problemática...")
    # Remover a migração 0098 que adiciona cargo_funcao
    migracao_problematica = "militares/migrations/0098_add_cargo_funcao_to_assinaturaalmanaque.py"
    if os.path.exists(migracao_problematica):
        os.remove(migracao_problematica)
        print(f"   Migração removida: {migracao_problematica}")
    ...
    print("7. Criando dados iniciais...")
    # Criar cargo padrão se não existir
