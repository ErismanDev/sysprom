...
def calendario_promocao_list(request):
    ...
    from .decorators import cargos_especiais_required
...
def calendario_promocao_visualizar_assinatura(request, pk):
    ...
    if request.user.username == 'usuario':
        ...
        if tem_funcao_especifica or membro_comissao or request.user.is_staff:
            can_sign = True
...
def calendario_promocao_assinar(request, pk):
    ...
    if not (tem_funcao_especifica or membro_comissao or request.user.is_staff):
