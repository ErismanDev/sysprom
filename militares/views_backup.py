...
def quadro_acesso_detail(request, pk):
    ...
    # Verificar se o usuário é o autor do quadro ou tem permissão para editar
    usuario_pode_editar = request.user == quadro.autor or request.user.has_perm('militares.change_quadroacesso')
