#!/usr/bin/env python
"""
Script para testar a funcionalidade de buscar funções do usuário para comissão
"""
...
def testar_funcoes_usuario_comissao():
    """Testa se o sistema de busca de funções do usuário para comissão está funcionando"""
    
    print("=== Teste do Sistema de Busca de Funções do Usuário para Comissão ===")
    ...
    try:
        ...
        # 6. Simular a busca de funções do usuário (como na view)
        print("\n6. Simulando busca de funções do usuário:")
        ...
        for funcao in funcoes:
            print(f"   - {funcao['nome']} ({funcao['tipo']})")
            print(f"     Período: {funcao['data_inicio']} a {funcao['data_fim'] or 'Atual'}")
        ...
        print("   ✓ Simulação da view buscar_funcoes_usuario")
...
if __name__ == '__main__':
    testar_funcoes_usuario_comissao() 