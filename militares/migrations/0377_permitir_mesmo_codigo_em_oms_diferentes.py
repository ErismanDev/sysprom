# Generated by Django 5.2.3 on 2025-11-12 19:03
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('militares', '0376_adicionar_controles_equipamentos_operacionais'),
    ...
    operations = [
        ...
        # Remover constraint unique do codigo se existir
        migrations.RunSQL(
            sql="""
                DO $$ 
                BEGIN
        ...
        # Adicionar unique_together apenas se não existir
        migrations.RunSQL(
            sql="""
                DO $$ 
                BEGIN
                    -- Adicionar unique_together se não existir
