...
def corrigir_datas_promocao_futuras():
    """
    Identifica e corrige militares com datas de promoção no futuro
    """
    print("=== CORREÇÃO DE DATAS DE PROMOÇÃO NO FUTURO ===\n")
    ...
    if militares_futuro.exists():
        ...
        resposta = input("Deseja corrigir as datas de promoção para hoje? (s/n): ").lower().strip()
        
        if resposta in ['s', 'sim', 'y', 'yes']:
            print("\n2. CORRIGINDO DATAS DE PROMOÇÃO...")
            print("-" * 40)
...
if __name__ == "__main__":
    corrigir_datas_promocao_futuras() 