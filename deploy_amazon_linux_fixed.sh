...
# Script de Deploy Personalizado - SEPROM CBMEPI (Amazon Linux 2023)
...
sudo dnf install -y python3 python3-pip python3-devel nginx postgresql15 postgresql15-server postgresql15-contrib git curl gcc
